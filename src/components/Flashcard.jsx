      ...
      {timer ? (
        <div id="timesUp">
          <div id="timeout-view">
            <h4>{`Time's up!`}</h4>
            <h4>{(score / 10) * 100}%</h4>
            <button onClick={() => handleResultData(userName, (score / 10) * 100, topic)}>Submit</button>
          </div>
        </div>
      ) : !currentFlashcard ? (
              ...
              <table>
                ...
                <tbody>
                  <tr>
                    ...
                    <td><button onClick={() => handleResultData(userName, (score / 10) * 100, topic)}>Exit</button></td>
                  </tr>
                </tbody>
              </table>
            </div>
